...
module NWConst::Library
  ...
  ENEMY_DESCRIPTION = {
    ...
    575 => [
      ...
      "opporunities to exercise divine",
    ...
    577 => [
      ...
      "associates the prisoners she monitors",
      "as sinners, and carries out predatory",
      "punishments on them accordingly.",
      "",
      "In times of emergency, she may be",
      "called upon for her fighting strength",
      "and use her predatory abilities to",
      "mercilessly devour the bodies and",
      "souls of the Goddess' enemies. She is",
      "an extremely cruel and greedy angel",
      "who is sometimes made fun of by other",
      "angels for committing the sin of",
      "gluttony herself.",
      "",
      "Artist: Delphinus",
    ],
    ...
    582 => [
      ...
      "angel control, they are said to wreak",
      "significant havoc. They primarily",
      "target only angels, and while they",
      "avoid harming other residents, they",
      "don't cooperate or coordinate with",
      "the resistance organizations on the",
      "surface, carrying out repeated",
      "assaults as an independent combat",
      "group.",
      "",
      ...
      "order in place regarding the topic of",
      "the \"Moon-Dwellers\", their existence",
      "is being whispered about amongst the",
      "general public.",
      "",
      "Artist: frfr",
    ],
    583 => [
      "A female warrior who appears to be an",
      "officer-ranked member of the Moon-",
      "Dwellers. While she has the same",
      "face as all of the other individuals,",
      "her hairstyle and armaments are",
      "different, implying that she is of a",
      "higher rank than the average soldier.",
      "Her combat abilities are also",
      "remarkably superior compared to",
      "average soldiers, possessing such",
      "power that even mid-ranking angels",
      "are no match for her. She also has",
      "such excellent judgement and tactical",
      "insight that despite having conducted",
      "repeated raids, not a single one of",
      "the Moon-Dwellers has ever been",
      "captured.",
      "",
    ...
    585 => [
      ...
      "astouding reproductiv eabilities,",
    ...
    593 => [
      ...
      "approach these restricted areas, they",
      "release an aphrodisiac gas that",
      ...
      "of the statue. Additionally, with the",
      "second Great Monster Wars in sight,",
      "they have been given the ability to",
      "patrol specific routes. They are",
      "stationed in multiple key locations",
      "as reserve forces that perform semi-",
      "automatic defense.",
      "",
      "Men who became petrified while having",
      "intercourse with the stone statue",
      "remain there as a warning to others.",
      "However, this has ended up arousing",
      "the sexual desires of some men, and",
      "there seems to be no shortage of them",
      "who are willing to throw themselves",
      "at the Themis Traps. Especially",
      "around some work sites, due to many",
      "instances of second-class citizens",
      "worn-out from working throwing",
      "themselves at Themis Traps, measures",
      "have been taken to remove them from",
      "these areas.",
      "",
      "Artist: frfr",
    ],
    ...
    596 => [
      ...
      "only tobe drained from. The Drain",
    ...
    598 => [
      ...
      "mass-produced using technology unique",
      "to the Angelic Dominion. She has",
      "diminished performance compared to",
      "the Drainroid, but the excessive",
      ...
      "have been future plans to deploy them",
      "in second-class citizen settlements",
      "for purposes such as semen",
      "harvesting, worker disposal, or for",
      "rewards.",
      "",
    ...
    608 => [
      ...
      "having been drastically weakened, she",
      "fought many battles while roaming the",
      "surface, regaining power equivilant",
      "to a high-ranking angel. In",
      "cooperation with the Ilias of the",
      "Angelic Dominion, she currently leads",
      "the three Seraphim in occupying the",
      "Monster Lord's Castle in the",
      "Singularity World. The Slime Girl and",
      "Dog Girl who are always at her side",
      "appear to have been her companions",
      "since the start of her adventure.",
      "",
      "Artist: Akazawa RED",
    ],
    609 => [
    ...
    610 => [
      ...
      "whtie magic to assist Ilias, but she",
    ...
    614 => [
      ...
      "While Luka's ability to interact with",
    ...
    618 => [
      ...
      "Fairy's Island to go wandering around",
      "on a journey, causing trouble",
      "wherever she went. It should be noted",
      "that most Chosen Ones in the Angelic",
      "Dominion misunderstand fairies to be",
      "young angels. But when a crisis",
      "arises in her homeland, she also",
      "displays a very proactive side of",
      "herself.",
      "",
    ...
    621 => [
      ...
      "appears to match the Little Bug's and",
      "Chimera Bug's, leading to speculation",
      "that some of their cells may have",
      "leaked into the environment. Their",
      "characteristics are no different from",
      "typical insect monsters, but they",
      "have greatly improved physical",
      "abilities. Their vitality has",
      "drastically increased, and they",
      "demonstrate fighting capabilities",
      "that make them difficult for angel",
      "angel soldiers to exterminate.",
      "",
      "They attack anyone who intrudes upon",
      "their territory, and should the",
      "intruder be a man, he will be forced",
      "to mate with them. Fortunately, their",
      "reproductive capabilities aren't high",
      "for insect-type monsters, so they",
      "don't explosively procreate.",
      "",
      "Artist: frfr",
    ],
    622 => [
      ...
      "Tongue's, leading to speculation that",
      "some of their cells may have leaked",
      "into the environment. They have",
      "tongue-like organs all over their",
      "bodies that they can extend and",
      "shrink freely, as well as taste with.",
      "They're said to sometimes capture",
      "living creatures by wrapping them in",
      "their tongues and licking them",
      "thoroughly to enjoy their taste.",
      "",
      ...
      "and three nights. The man will simply",
      "die from exhaustion in most cases, so",
      "caution is necessary around them.",
      "",
      "Artist: Setouchi",
    ],
    623 => [
    ...
    624 => [
      ...
      "carelessly approach her chrysalis, it",
      "will automatically capture you with",
      "its tentacles and suck out your",
    ...
    625 => [
      ...
      "planet's energy hidden within her has",
      ...
      "the planet any more, she has become a",
      "monstrosity guided by the impulses of",
      "chaos who now seeks destruction.",
      "",
      "Artist: UN_DO",
    ],
    626 => [
    ...
    648 => [
      ...
      "transcendant being of catastrophe who",
      "enjoys seeing parallel worlds meet",
      "their ends. Able to wield both holy",
      "and dark energy simultaneously, she",
      "possesses unbelievable power",
    ...
    650 => [
      "A strange chimeric monster whose form.",
      "resembles a cluster of hair. This one",
      "was created in a manner similar to",
      "spiritualism by exposing hair cut",
      "from young women to high",
      ...
      "energy and eveb absorb their very",
      "body into her.",
      "",
    ...
    661 => [
      ...
      "as the Daystar. Created as a fragment",
      "of Ilias herself, she boasts",
      "outstanding power unmatched by anyone",
      "in Heaven except for her older",
      "sister, Micaela. She has an",
      ...
      "feared Lucifina as a devil, with some",
      "even having taken their own lives",
      "upon hearing word of her arrival on",
      "the battlefield.",
      "",
      ...
      "Dominion's forces watch the with",
      "trepidation.",
      "",
      "Artist: frfr",
    ],
    ...
    669 => [
      ...
      "and water and are experts at healing.",
      "Also, because of the nature of their",
      "duties, they have a deep knowledge of",
      "poisons and contaminants, and are",
      "said to be able to easily interfere",
      "with elements and break down",
      "pollutants, or conversely create",
      "them. They appear to be relatively",
      "new angels that were created to",
      "reduce pollution caused by internal",
      "combustion engines used in parts of",
      "the Angelic Dominion as its",
      "population increased. Their",
      "production costs are incredibly",
      "high however, and their numbers",
      "aren't keeping up with the demand,",
      "so reducing their costs appears to be",
      "a major issue.",
      "",
    ...
    677 => [
      ...
      "roam about freely in the Ilias Temple",
      "as defense forces due to their",
      "tendency to attack any unregistered",
      "individuals who approach them.",
      "",
      "Upon discovering unregistered",
      "intruders, they will attack to",
      "incapacitate them, then take them",
      "into their bodies. Their pitiful prey",
      "will be immersed in ecstasy as they",
      "are swallwed in a vortex of chaos.",
      "It should be noted that they don't",
      "just attack intruders, but even",
      "angels who should be registered are",
      "attacked by them as well.",
      "",
      "Artist: frfr",
    ],
    678 => [
    ...
    719 => [
      ...
      "when they were still weren't distinct.",
      "They originally lurked deep beneath",
      "the seas and rarely came up onto",
      "land. After the seas became polluted",
      "from the Great Monster Wars however,",
      "many of them adapted to fresh water",
      "and moved into uncontaminated springs",
      "and underground resivoirs. As a",
      "result, territorial disputes have",
      "arisen with the scylla who had been",
      "living in those waters all along, and",
      "the deep sea species have become",
      ...
      "gods in some regions, but because the",
      "scylla race tends to look down upon",
      "the deep sea species, they remain",
      "shadowy presences despite their",
      "outstanding abilities.",
      "",
      "Since they originally lived in the",
      "deep sea, their ecology allows them",
      "to remain active for long periods of",
      "time with very little food. Even when",
      "they capture a man, they keep him",
      "captive to make him slowly dependent",
      "on them as they slowly squeeze his",
      "semen over a length of time instead",
      "of immediately wringing it all out of",
      "him. In the past, they would",
      "sometimes carry men off into the",
      "depths of the sea, which is believed",
      "to have inspired various folk tales.",
      "",
      "Artist: UN_DO",
    ],
    720 => [
    ...
    733 => [
      ...
      "between the two have been identified,",
      "with the Marchosias appearing to be",
      "the most significant among these",
      "species. Ferocious and boasting",
      ...
      "lives. The exhausted man will then be",
      "left at a nearby settlement and set",
      "free.",
      "",
      "Artist: Uminoyama",
    ],
    ...
    742 => [
      ...
      "the in Monster Realm's forests. They",
      ...
      "theorize that this mutation is due to",
      "the influence of chaos. They boast",
      "overwhelming regeneration and",
      "vitality, with extraordinary physical",
      "abilities for a plant species. While",
      "they are gentle-natured, they can",
      "cause widespread destruction just",
      "from moving because of their enormous",
      "size. Regardless of their intentions,",
      "they are feared as incredibly",
      "dangerous monsters. On another note,",
      "Kanon's subordinates have attempted",
      "to recruit the Giga Dryads, but they",
      "preferred to idle around in the",
      "forest, and wouldn't pay them any",
      "heed.",
      "",
      ...
      "takes him into her body. Although the",
      "Giga Dryads don't harbor any malice,",
      "they inevitably end up squeezing men",
      "until their deaths.",
      "",
      "Artist: frfr",
    ],
    ...
    752 => [
      ...
      "The theme for this one was \"Erosion",
      "of Time\", and her figure was",
      "deliberately regressed to the form of",
      "a young girl. In addition to her time",
      "magic and dark arts, her attacks",
      "utilizing her insect organs are all",
      "very powerful. Her insect carapace",
      "also provides great defense, making",
      "her incredibly durable for a mage-",
      "type puppet.",
      "",
      "Artist: UN_DO",
    ],
    ...
    761 => [
      ...
      "properly due to issues with the two's",
      "thought links, causing them to be",
      "mentally broken. Frankly speaking,",
      "this was a failure, but Kagetsumugi",
      "refuses to admit it, insisting that",
      "their theme is \"The Dissonance Woven",
      "from Madness and Imbalance\".",
      "",
      "Artist: UN_DO",
    ],
    762 => [
    ...
    778 => [
      "One of the Four Spirits that exists",
      "in the Monster Realm, she is the",
      "spirit who governs earth. She resides",
      "within the Safar Ruins waiting for",
      "someone to visit and talk to her.",
      "Her body is made out of mud and",
      "similar to a slime's in its ability",
      "to change shape at will. Her fighting",
      "capabilities are surprisingly high",
      "as not only can she create tsunamis",
      "out of her mud, but she can harden it",
      "as well for incredible defense. She",
      "really likes to chat, and will talk",
      "nonstop for hours if left to do so.",
      "However, since the land of Sabasa is",
      "ruled by Hiruko and neither humans",
      "nor monsters dare set foot there, she",
      "is frustrated that there is hardly",
      "anyone no one to talk to.",
    ...
    781 => [
      "An artificial train-type monster that",
      "travels around the Monster Realm.",
      "Originally just a non-combat vehicle",
      "that transported passangers, she",
      "gained experience as she ran over",
      "monsters that crossed her tracks. As",
      "her level increased significantly, so",
      "too did her combat abilities rise",
      "drastically. Even still, there is an",
      "unbearable amount of violence on the",
      "tracks with not just train robbers,",
      "but also those boastful of their",
      "strength who try to stop the Monster",
      "Train head-on under the notion of",
      ...
      "running for half a month before he is",
      "completely drained of energy. In the",
      "Monster Realm where human lives are",
      "considered to have little value, she",
      "is very useful as a transportation",
      "infrastructure that can operate at an",
      "incredibly low cost.",
      "",
      "Artist: xelvy",
    ],
    ...
    783 => [
      ...
      "admiration for the popular culture of",
      "city-dwelling humans, especially the",
      "youth culture. Carrying the latest",
      "miniaturized makina known as",
      "smartphones and talking in a strange",
      "dialect, Rogue Elves are frowned upon",
      "by dignified yoma nobles, who",
      "strictly forbid contact with them to.",
      "protect their from their influence.",
      "Since many of them are the daughters",
      "of high-ranking elves, they also",
      "possess extraordinary fighting",
      "prowess. They have even mastered",
      "traditional ancient elven bow skills,",
      "which they use to mercilessly strike",
      "down invaders and elders who try to",
      "rehabilitate them. They appear to get",
      "along well with the High Baphomets,",
      "who are rather understanding towards",
      "them and respect their values.",
      "",
    ...
    785 => [
      ...
      "",
      "Since the Monster Lord puppets were",
      "completed, lower-grade materials and",
      "core duplication technology were used",
      "to successfully mass-produce a few",
      "more of them. They are stationed in",
      "their master's base, the Black",
    ...
    792 => [
      ...
      "properly due to issues with the two's",
      "thought links, causing them to be",
      "mentally broken. Franklly speaking,",
      "this was a failure, but Kagetsumugi",
      "refuses to admit it, insisting that",
      "their theme is \"The Dissonance Woven",
      "from Madness and Imbalance\".",
    ...
    804 => [
      ...
      "the Whtie Rabbit and Reaper's data,",
    ...
    823 => [
      ...
      "alliance with the Dark Goddess of the",
      "Monster Realm, and is trying to fight",
      "against the chaos phenomenon in order",
      "to avert the world's destruction. She",
      "stands in the way of Luka and his",
      "party as they enter the Dark",
      "Goddess' Castle, but it seems as if",
      "she already knows how how this",
      "encounter will end.",
      "",
      "Artist: Kenkō Cross",
    ],
