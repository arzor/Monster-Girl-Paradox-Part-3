...
module NWConst::Library
  ...
  ACTOR_FIX_ABILITY = {
    ...
    32 => ["Commander of Heaven's Army",
      ...
      "+100% damage. Spear and Holy skills can use Attack in place",
      "of other stats. Holy skills chain into Spear, then Sword",
      "skills",
    ],
    33 => ["Fallen Commander",
    ...
    192 => ["Group Paizuri",
      ...
      "breasts execute an additional time, but have 150% SP cost.",
    ],
    193 => ["Wolf Tentacle",
    ...
    199 => ["Drifting Dagon",
      "Can always use Tentacle/Ocean skills. Tentacle skills deal",
      "+15% damage. Ocean skills have a 30% chance to inflict Sleep.",
      "+20% Evasion/Magic Evasion.",
    ],
    200 => ["Hitodama Fire",
    ...
    296 => ["Pride of the Nereneid Family",
    ...
    327 => ["Mermaid Princess",
      ...
      "priority. +15% to all stats if Laura is in the main",
      "party.",
    ],
    328 => ["Queen Mermaid",
    ...
    379 => ["Tranquil Queen Scylla",
      ...
      "50% more damage. White Magic skills can use Dexterity in",
      "place of Willpower. Chains White Magic skills into Tentacle",
      "skills.",
    ],
    382 => ["Aura Succubus",
    ...
    438 => ["Blitz of Retribution",
      ...
      "Thunder and deal +100% damage to Shocked foes. Starts battles",
      "with Spellblade Thunder active. Immune to Lightning.",
    ],
    ...
    440 => ["Cruel Serpent Angel",
      ...
      "to Paralyzed and Bound foes. Automatically uses Queen's Roll",
      "at the end of turn.",
    ],
    441 => ["Medusa + Dullahan",
      "Normal attack hits an additional time. Snake skills execute",
      "an additional time, but have 133% SP cost. 35% chance of",
    ...
    444 => ["Valiant Angel of the Cutting Charge",
      ...
      "use Sword and Multiweapon skills, dealing +30% damage with",
      "increased priority. Chains Sword skills into Multiweapon",
      "skills.",
    ],
    ...
    450 => ["Verdant Plant",
      "Innate Sleep+Bind Strike 30%. Can always use Alchemy and Plant",
      "skills. Plant skills shave a 30% chance to inflict Sleep",
      "and Bind, and deal +150% damage to sleeping or bound foes.",
      "50% chance of not consuming materials when using Alchemy skills.",
    ],
    ...
    468 => ["Bedchamber Angel's Curtain",
    ...
    605 => ["Queen Inheriting Heroic Blood",
    ...
    614 => ["Magus Doctor",
      ...
      "skills deal +30% damage with 66% MP/SP cost. May use",
      "Cleansing Honey on allies at the end of turn.",
    ],
    ...
    655 => ["Semen-Sucking Girl",
      ...
      "stat-weakened foes. Chains Tentacle skills into Summoning",
      "skills.",
    ],
    ...
    665 => ["Big Whale",
      ...
      "by Element Weak effects. Chains Ocean skills into Giant",
      "skills. Immune to Nano damage.",
    ],
    ...
    697 => ["Administrator of Eternity", #NOTE: Can also use Chaos skills and gets a boost for them, not mentioned in the original Japanese text.
      "Gets an additional action every turn. Deal +100% Eternal/",
    ...
    699 => ["Administrator of the End", #NOTE: Can also use Chaos skills and gets a boost for them, not mentioned in the original Japanese text.
    ...
    700 => ["Ideal Hero Archetype", #NOTE: Can also use Chaos skills and gets a boost for them, not mentioned in the original Japanese text.
      "Gets an additional action every turn. Deal +100% Carnage",
    ...
    707 => ["Goddess of Chaos", #NOTE: Immune to Galactic element as well, despite often being regarded a chaos element in many other cases.
      "Gets an additional action every turn. Deal +100% damage",
      "with all Chaos elements and pierces resistances to them.",
    ...
    717 => ["Pretend Doctor",
      ...
      "skills. Medicine skills execute an additional time, but have",
      "133% SP cost.",
    ],
    ...
    734 => ["Fifth Monster Lord Puppet",
      ...
      "of other stats. Chains Dark or Artificial skills into Slime,",
      "then Katana skills.",
    ],
    ...
    760 => ["Divine-Impregnated Machine",
      "Deal +75% Carnage/Eternal/Demise damage. Physical, Holy, and",
      "Dark attacks also inflict their respective chaos element",
    ...
    761 => ["Anti-Apoptosis Annihilation Machine",
    ...
    762 => ["Ultimate Zombie Final Model", #NOTE: Does not have the innate ability to wear Heavy Armor in her Actor data.
    ...
    765 => ["Chrome's Masterpiece: The Ultimate Doll",
    ...
    773 => ["Idaten Flying Oni", #NOTE: Supposed to have innate Agility/Dexterity increase, but isn't present in actor data.
    ...
    785 => ["Planet Guardian Butterfly Chrysalis",
    ...
    789 => ["Original Sin of All Creation",
      "Gets an additional action every turn. Can always equip",
    ...
    793 => ["Extradimensional Invading Tentacle Colony",
    ...
    796 => ["Strongest in History, Unprecedented and Unmatched",
    ...
    801 => ["Hero of the Dream World",
      ...
      "and Knight Swords. Can always use Sword, Heroism, and",
      "Sexcraft skills. Sword and Heroism skills deal +30% damage.",
      "Sword skills deal +1% damage for every % of missing HP.",
      "+15% to all stats if Rovissa is in the main party.",
    ],
    ...
    807 => ["Witch's Disciple",
      ...
      "deal +30% damage. Black Magic and Summoning deal +1% damage",
      "for every % of missing HP.",
    ],
    808 => ["School Dropout",
    ...
    815 => ["Spirit of Compassion",
      ...
      "Swords, Rods, and Guns. Can always use Black Magic, Sword,",
      "and Gun skills, dealing +15% damage. Gun skills deal +100%",
      "damage to foes affected by binds or pleasure ailments. Black",
      "Magic and Sword skills can use Dexterity in place of other",
      "stats. Sword and Gun skills have an 80% chance to inflict",
      "Bleed. 200% Recruit rate.",
    ],
    816 => ["Soul Lamp",
    ...
    843 => ["The Fifth Law: Holy Aberration",
      "Deal +100% Eternal damage and pierce Eternal resistance. Holy",
      "attacks also inflict Eternal damage Can always equip Clubs",
      "and Staves. Can always use Club, White Magic, Holy, and Chaos",
    ...
    844 => ["The Fifth Law: Dark Aberration",
    ...
    845 => ["The Fifth Law: Final Aberration",
    ...
    854 => ["Elite Chaos Guard", #NOTE: Inverted normal/chaos element resistances?
      ...
      "Stigmata. 50% of Agility is added to Holy and Artificial",
      "skill power. Chains Holy skills into Artificial, then Spear",
      "skills. Halves Eternal/Demise damage taken, and quarters",
      "Holy/Dark damage taken.",
    ],
    ...
    863 => ["Eroded Chaos Angel",
      ...
      "skills. Takes 75% damage from Chaos element attacks.",
    ],
    ...
    865 => ["Otherworldly Gun Goddess",
      ...
      "always use Gun skills, executing two additional times, but",
      "have doubled SP cost.",
    ],
    ...
    875 => ["Ominous Flower Blooming in Another World", #NOTE: End of turn Recovery Honey appears to trigger off many debuffs that it cannot cure?
    ...
    877 => ["Otherworldly Phantom Specter",
    ...
    881 => ["Otherworldly Yoma",
      ...
      "Demon Arts skills, dealing +30% damage (+150% to foes",
      "afflicted with pleasure ailments) with halved MP/SP cost and",
      "inflict Hadron and Nightmare damage. Chains Psychic skills",
      "into Demon Arts skills. Takes halved damage from Hadron and",
      "Nightmare attacks.",
    ],
    ...
    897 => ["Kin Crawling from the Dark",
    ...
    904 => ["Otherworldly ？？？？",
      ...
      "Sorcery skills have persistence. Deals +75% damage when using",
    ...
    913 => ["Floating Subspace Entity",
      "Maximum HP +30%. Deal +50% Gravity/Galactic damage. Can",
      "always equip Rods. Can always use Time Magic and Demon Arts,",
      "dealing +50% damage and inflict Gravity/Galactic damage.",
      "Demon Eyes skills +50% damage. Demon Arts skills deal +150%",
      "damage to Slowed/Stopped foes. Chains Time Magic skills into",
      "Demon Arts, then Demon Arts skills. Absorbs Carnage/Demise/",
      "Galactic damage.",
    ],
    914 => ["Otherworldly Devil Queen",
    ...
    917 => ["Cybernetic Warrior",
      ...
      "element damage and takes 25% less Carnage damage.",
    ],
    918 => ["Friendly Neighborhood Fox-Girl",
      "+30% Evasion/Magic Evasion/Auto-Hit Evasion Rate. Can always",
    ...
    921 => ["Great Phantom Thief M's Successor",
    ...
    924 => ["Friendly Neighborhood Fox-Girl",
      "+30% Evasion/Magic Evasion/Auto-Hit Evasion Rate. Can always",
      "equip Fists. Can always use Unarmed skills. Unarmed and",
      "Justice skills deal +50% damage. Heaven or Hell and Bullet",
      "Time effect durations are extended by two turns.",
    ],
    925 => ["Man-Slaying Kitsune",
      "Can always equip Katanas. Can always use Katana skills,",
      "dealing +50% damage with halved SP cost. Multi-hit Katana",
      "skills inflict three additional hits. Deals +150% damage",
      "to Humans. Nullifies and counters incoming Sword, Rapier,",
    ...
    926 => ["Great Phantom Thief M's Successor",
      "+15% Evasion/Magic Evasion/Auto-Hit Evasion Rate. Innate Dual",
      "Wield. Can always equip Daggers. Can always use Dagger,",
      "Thievery, and Sexcraft skills with halved SP cost. Multi-hit",
      "Dagger and Sexcraft skills inflict three additional hits.",
