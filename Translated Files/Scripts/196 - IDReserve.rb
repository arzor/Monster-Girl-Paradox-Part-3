...
module NWConst::Warp
  # ワープ先一覧
  Places = [
    {:name => "Pocket Castle", :map_id => 126, :x => 15, :y => 13, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Ilias Temple", :map_id => 5, :x => 24, :y => 11, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Iliasville", :map_id => 2, :x => 295, :y => 356, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Iliasburg", :map_id => 2, :x => 300, :y => 326, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 302, 326]},    
    {:name => "Nameless Slums", :map_id => 2, :x => 236, :y => 341, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 235, 341]},    
    {:name => "Pornof", :map_id => 2, :x => 349, :y => 377, :category => :"Singularity World",
      :v2location => [[2, 349, 382, "v[1001]>=30"],[2, 284, 274, "true"]], :v3location => [2, 351, 377]},
    {:name => "Happiness Village", :map_id => 2, :x => 353, :y => 326, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 352, 326]},    
    {:name => "Midas Village", :map_id => 2, :x => 366, :y => 279, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 367, 279]},    
    {:name => "Medal Queen's Castle", :map_id => 2, :x => 338, :y => 273, :category => :"Singularity World",
      :v2location => [2, 338, 268], :v3location => [2, 339, 273]},    
    {:name => "Enrika", :map_id => 2, :x => 241, :y => 368, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 284, 363]},    
    {:name => "Rostrum Village", :map_id => 2, :x => 385, :y => 354, :category => :"Singularity World",
      :v2location => [[2, 388, 353, "v[1001]>=30"],[2, 284, 274, "true"]], :v3location => [2, 386, 354]},   
    {:name => "Iliasport", :map_id => 2, :x => 282, :y => 275, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 281, 275]},    
    {:name => "Port Natalia", :map_id => 2, :x => 282, :y => 260, :category => :"Singularity World",
      :v2location => [2, 284, 261], :v3location => [2, 281, 260]},    
    {:name => "Luddite Village", :map_id => 2, :x => 257, :y => 250, :category => :"Singularity World",
      :v2location => [2, 284, 261], :v3location => [2, 258, 250]},    
    {:name => "San Ilia", :map_id => 2, :x => 236, :y => 261, :category => :"Singularity World",
      :v2location => [[2, 234, 268, "v[1001]>=30"],[2, 284, 261, "true"]], :v3location => [2, 238, 261]}, 
    {:name => "Monte Carlo", :map_id => 2, :x => 200, :y => 273, :category => :"Singularity World",
      :v2location => [2, 284, 261], :v3location => [2, 201, 273]},    
    {:name => "Rubiana", :map_id => 2, :x => 142, :y => 317, :category => :"Singularity World",
      :v2location => [[2, 141, 318, "v[1001]>=30"],[2, 284, 261, "true"]], :v3location => [2, 143, 317]},
    {:name => "Sabasa", :map_id => 2, :x => 103, :y => 294, :category => :"Singularity World",
      :v2location => [[2, 104, 296, "v[1001]>=30"],[2, 100, 225 ,"true"]], :v3location => [2, 105, 294]},    
    {:name => "Grandeur", :map_id => 2, :x => 85, :y => 272, :category => :"Singularity World",
      :v2location => [2, 100, 225], :v3location => [2, 84, 272]},    
    {:name => "Magistea Village", :map_id => 2, :x => 47, :y => 295, :category => :"Singularity World",
      :v2location => [[2, 37, 292, "v[1001]>=30"],[2, 100, 225, "true"]], :v3location => [2, 46, 295]},  
    {:name => "Saloon", :map_id => 2, :x => 98, :y => 230, :category => :"Singularity World",
      :v2location => [2, 100, 225], :v3location => [2, 100, 230]},    
    {:name => "Port Marle", :map_id => 2, :x => 254, :y => 234, :category => :"Singularity World",
      :v2location => [2, 253, 232], :v3location => [2, 253, 234]},    
    {:name => "Navy Headquarters", :map_id => 2, :x => 335, :y => 240, :category => :"Singularity World",
      :v2location => [2, 334, 240], :v3location => [2, 338, 240]},    
    {:name => "Finoa", :map_id => 2, :x => 330, :y => 209, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 329, 209]},    
    {:name => "Grand Noah", :map_id => 2, :x => 328, :y => 187, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 327, 187]},    
    {:name => "Yamatai Village", :map_id => 2, :x => 372, :y => 166, :category => :"Singularity World",
      :v2location => [[2, 379, 167, "v[1001]>=30"],[2, 322, 227, "true"]], :v3location => [2, 374, 166]},  
    {:name => "Esta", :map_id => 2, :x => 261, :y => 202, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 263, 202]},    
    {:name => "Plansect Village", :map_id => 2, :x => 283, :y => 198, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 282, 198]},    
    {:name => "Lima Ruins", :map_id => 2, :x => 236, :y => 179, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 235, 179]},    
    {:name => "Goddard", :map_id => 2, :x => 221, :y => 176, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 223, 176]},    
    {:name => "Grangold", :map_id => 2, :x => 234, :y => 154, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 233, 154]},    
    {:name => "Gold Port", :map_id => 2, :x => 234, :y => 131, :category => :"Singularity World",
      :v2location => [[2, 233, 130, "v[1001]>=30"],[2, 322, 227, "true"]], :v3location => [2, 236, 131]}, 
    {:name => "Succubus Village", :map_id => 2, :x => 165, :y => 142, :category => :"Singularity World",
      :v2location => [[2, 168, 121, "v[1001]>=30"],[2, 322, 227, "true"]], :v3location => [2, 167, 142]},  
    {:name => "Lady's Village", :map_id => 2, :x => 150, :y => 122, :category => :"Singularity World",
      :v2location => [[2, 168, 121, "v[1001]>=30"],[2, 322, 227, "true"]], :v3location => [2, 152, 122]},  
    {:name => "Holy Wings Shrine", :map_id => 2, :x => 134, :y => 125, :category => :"Singularity World",
      :v2location => [[2, 168, 121, "v[1001]>=30"],[2, 322, 227, "true"]], :v3location => [2, 135, 125]},   
    {:name => "Fairy's Island", :map_id => 2, :x => 42, :y => 348, :category => :"Singularity World",
      :v2location => [2, 46, 338], :v3location => [2, 43, 346]},    
    {:name => "Elf Village", :map_id => 300, :x => 23, :y => 50, :category => :"Singularity World",
      :v2location => [2, 365, 157], :v3location => [2, 372, 160]},    
    {:name => "Kitsune Village", :map_id => 2, :x => 388, :y => 158, :category => :"Singularity World",
      :v2location => [2, 379, 167], :v3location => [2, 389, 158]},    
    {:name => "Snow Heaven", :map_id => 2, :x => 89, :y => 158, :category => :"Singularity World",
      :v2location => [2, 82, 144], :v3location => [2, 91, 158]},    
    {:name => "Ilias Temple Ruins", :map_id => 2, :x => 33, :y => 193, :category => :"Singularity World",
      :v2location => [2, 82, 144], :v3location => [2, 35, 193]},    
    {:name => "Hellgondo Shrine", :map_id => 2, :x => 223, :y => 93, :category => :"Singularity World",
      :v2location => [2, 203, 102], :v3location => [2, 297, 356]},    
    {:name => "Monster Lord's Castle", :map_id => 2, :x => 164, :y => 55, :category => :"Singularity World",
      :v2location => [2, 203, 102], :v3location => [2, 297, 356]},    

    {:name => "Missing Number", :map_id => 1193, :x => 261, :y => 202, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Administrator's Tower", :map_id => 1303, :x => 25, :y => 23, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Esta", :map_id => 1193, :x => 261, :y => 202, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Rubiana", :map_id => 1193, :x => 142, :y => 317, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Sabasa", :map_id => 1193, :x => 103, :y => 294, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},   
    {:name => "Finoa", :map_id => 1193, :x => 330, :y => 209, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Grand Noah", :map_id => 1193, :x => 328, :y => 187, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Grangold", :map_id => 1193, :x => 234, :y => 154, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Goddard", :map_id => 1193, :x => 226, :y => 174, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Sealed Sinner's Prison", :map_id => 1193, :x => 243, :y => 82, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Monster Lord's Castle", :map_id => 1193, :x => 162, :y => 50, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},  
    {:name => "Port Natalia", :map_id => 1193, :x => 282, :y => 260, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "San Ilia", :map_id => 1193, :x => 236, :y => 260, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Alliance of Wisdom Laboratory", :map_id => 1495, :x => 29, :y => 56, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Lucifina's House", :map_id => 1006, :x => 23, :y => 6, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Iliasburg", :map_id => 1193, :x => 300, :y => 326, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},   
    {:name => "Ilias Temple", :map_id => 1193, :x => 295, :y => 356, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},    
    {:name => "Ilias Temple", :map_id => 1890, :x => 29, :y => 54, :category => :"Angelic Dominion",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 

    {:name => "Hellgondo Shrine", :map_id => 1001, :x => 223, :y => 92, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Succubus Village", :map_id => 1001, :x => 165, :y => 141, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Gold Port", :map_id => 1001, :x => 234, :y => 130, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Grangold", :map_id => 1001, :x => 234, :y => 153, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Plansect Village", :map_id => 1001, :x => 283, :y => 197, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Grand Noah", :map_id => 1001, :x => 328, :y => 186, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Yamatai Village", :map_id => 1001, :x => 372, :y => 165, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Finoa", :map_id => 1001, :x => 330, :y => 208, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Port Natalia", :map_id => 1001, :x => 282, :y => 261, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "San Ilia", :map_id => 1001, :x => 237, :y => 260, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Monte Carlo", :map_id => 1001, :x => 200, :y => 272, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Sabasa", :map_id => 1001, :x => 103, :y => 293, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Enrika", :map_id => 1001, :x => 240, :y => 368, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Dark Goddess' Castle", :map_id => 1001, :x => 164, :y => 54, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Dark Goddess' Castle", :map_id => 1650, :x => 30, :y => 52, :category => :"Monster Realm",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},  

    {:name => "Missing Number", :map_id => 1193, :x => 261, :y => 202, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]},  
    {:name => "Missing Number", :map_id => 1193, :x => 261, :y => 202, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Missing Number", :map_id => 1193, :x => 261, :y => 202, :category => :"Singularity World",
    ...
    {:name => "Missing Number", :map_id => 1193, :x => 261, :y => 202, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Iliasville (Alt)", :map_id => 196, :x => 59, :y => 54, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Rostrum (Alt)", :map_id => 195, :x => 38, :y => 20, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Administrator's Tower (Alt)", :map_id => 197, :x => 58, :y => 12, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Succubus Village (Alt)", :map_id => 194, :x => 74, :y => 120, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Remina (Alt)", :map_id => 194, :x => 55, :y => 63, :category => :"Singularity World",
      :v2location => [2, 322, 227], :v3location => [2, 117, 138]},    
    {:name => "Monster Lord's Castle (Alt)", :map_id => 194, :x => 73, :y => 33, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Missing Number", :map_id => 1193, :x => 261, :y => 202, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    {:name => "Alliance of Wisdom Laboratory (Alt)", :map_id => 439, :x => 29, :y => 56, :category => :"Singularity World",
      :v2location => [2, 284, 274], :v3location => [2, 297, 356]}, 
    ...
    {:name => "Lucifina's House", :map_id => 1840, :x => 23, :y => 6, :category => :混沌,
      :v2location => [1287, 284, 274], :v3location => [1287, 297, 356]},
    {:name => "Lunar Mechanical Fortress", :map_id => 1837, :x => 40, :y => 16, :category => :混沌,
      :v2location => [1287, 284, 274], :v3location => [1287, 297, 356]},
    {:name => "Sealed Monster's Cave", :map_id => 1287, :x => 182, :y => 158, :category => :混沌,
      :v2location => [1287, 322, 227], :v3location => [1287, 182, 160]},
    {:name => "Chaos Domain", :map_id => 1836, :x => 10, :y => 8, :category => :混沌,
      :v2location => [1287, 284, 274], :v3location => [1287, 297, 356]}, 
